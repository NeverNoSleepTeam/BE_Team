...
public class BoardService {
    ...
    public ResponseEntity<Map<String, String>> create(String token, ModelAssistanceCreateDto request,
        ...
        try {
            ...
            String titleValue = saveTitleFile(id, email, title);
            List<String> detailsValue = saveDetailFiles(id, email, details);
...
//    public ModelAssistanceBoard
    ...
    private String saveTitleFile(Long id, String email, MultipartFile file) throws IOException {
    ...
    private List<String> saveDetailFiles(Long id, String email, List<MultipartFile> files) throws IOException {
